...
urlpatterns = [
    ...
    path('conflict-check/', views.conflict_check_view, name='conflict-check'),
    ...
    path('cases/<uuid:uuid>/timeline/', views.case_timeline_view, name='case-timeline'),
    path('cases/<uuid:uuid>/dossier/', views.case_dossier_view, name='case-dossier'),
